...
class Player(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        if keystate[pg.K_RIGHT]:
            if self.rect.right <= scr_width - 25:
                self.vel_x = 4.07
...
class AI(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        walls_left = self.rect.left >= 25
        walls_right = self.rect.right <= scr_width - 25
...
class Ball(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.left <= 15 and self.vel_x < 0 or self.rect.right >= scr_width - 15 and self.vel_x > 0:
...
class Ohjelma:
    ...
    def __init__(self):
        ...
        thickness = 10
        w_left = Wall(thickness, scr_height, color, 0, scr_height)
        w_right = Wall(thickness, scr_height, color, scr_width - thickness, scr_height)
        self.wall_group = pg.sprite.Group()   
        self.wall_group.add(w_left, w_right)
